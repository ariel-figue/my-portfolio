  ...
  <FadeInSection>
    ...
    <div className="max-w-5xl">
      ...
      <p className="mt-4">
        ...
        My passion for innovative software engineering is fueled by my love for
        creating solutions to real-world problems and continuously building and
        improving impactful tools.
      </p>
      <p className="mt-4">
